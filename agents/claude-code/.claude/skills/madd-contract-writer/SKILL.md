...
description: This skill should be used when writing or updating the MADD contract files in .madd/contract.d/. Use when creating specifications, updating task status, or modifying any contract JSON file. Provides structure rules, validation, and write permission boundaries.
version: 0.1.0
---
...
| Role | Allowed Writes |
|------|---------------|
| **madd-architect** | `00-meta.json`, `10-intention.json`, `20-functional.json`, `30-technical.json`, `40-tasks.json`, `50-operations.json` |
| **madd-maker** | `40-tasks.json` (status fields only) |
| **madd-conductor** | `60-audit-cycle.json` |
| **madd-witness** | `90-retro.json`, `CHANGELOG.md` |
| **madd-breaker** | None (read-only) |
