...
description: This skill should be used when reading, understanding, or querying the MADD contract in .madd/contract.d/. Use when the user mentions "contract", "requirements", "specification", "intention", or when any MADD agent needs to read the contract state.
version: 0.1.0
---
