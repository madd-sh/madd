...
description: This skill should be used when the dev agent needs to fix audit findings. Use when processing "audit feedback", "CHANGES_REQUIRED", "fix findings", "REC-xxx", "blocker", or when iterating on audit corrections. Provides the structured correction process with traceability.
version: 0.1.0
---
